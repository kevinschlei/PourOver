...
//========================================
/*
 NOTE: to finish installing this into libpd...
 
 1. add this file to the libpd project
 
 2. add to Target Membership libpd.a (in the Utilities File inspector)
 
 3. add this line to m_pd.h:
 EXTERN void psrControllerRequest(const char *s);
 
 4. add this line to m_pd.c:
 void x_psr_setup(void);
 
 5. add this line to m_pd.c pd_init{...:
 x_psr_setup();
